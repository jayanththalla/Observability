...
When you build an LLM app and it gives a wrong answer, is slow, or costs too much — how do you figure out _why_?
...
**What you learn:** Build an agent that _decides_ whether to search the knowledge base, using a plain Python function as a tool.
